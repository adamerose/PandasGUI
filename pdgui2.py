...
class PandasGUI(QtWidgets.QMainWindow):
    ...
    def get_chart_parameters(self):
        ...
        item, ok_pressed = QtWidgets.QInputDialog.getItem(self, "select input dialog",
                                                          ...
                                                          0, False)
        # t = QtWidgets.QDialogButtonBox(QtCore.Qt.Vertical)
        # l = QtWidgets.QVBoxLayout()
        # buttons = QDialogButtonBox(
        #     QDialogButtonBox.Ok | QDialogButtonBox.Cancel,
        #     Qt.Vertical, self)
        # column_1 = QtWidgets.QComboBox(t)
        # column_1.addItems(self.shown_df.columns)
        # column_2 = QtWidgets.QComboBox(t)
        # column_2.addItems(self.shown_df.columns)
        # l.addWidget(t)
        # t.addWidget(b)
        # t.exec_()
