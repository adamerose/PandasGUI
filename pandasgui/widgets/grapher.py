...
class Grapher(QtWidgets.QWidget):
    def __init__(self, pgdf: PandasGuiDataFrame):
        ...
        self.plot_type_picker.setSizePolicy(
        ...
        # Initial selection
        self.plot_type_picker.setSelectionMode(
...
def line(**kwargs):
    key_cols = []
    for arg in [
        a for a in ["x", "color", "facet_row", "facet_col"] if a in kwargs.keys()
    ]:
...
schemas = [
    Schema(
        ...
        icon_path=os.path.join(
            pandasgui.__path__[0], "images/plotly/trace-type-histogram.svg"
        ),
    ),
    Schema(
        name="scatter",
        ...
        function=px.scatter,
        icon_path=os.path.join(
            pandasgui.__path__[0], "images/plotly/trace-type-scatter.svg"
        ),
    ),
    Schema(
        name="line",
        ...
        function=line,
        icon_path=os.path.join(
            pandasgui.__path__[0], "images/plotly/trace-type-line.svg"
        ),
    ),
    Schema(
        name="bar",
        ...
        function=bar,
        icon_path=os.path.join(
            pandasgui.__path__[0], "images/plotly/trace-type-bar.svg"
        ),
    ),
    Schema(
        name="box",
        ...
        function=px.box,
        icon_path=os.path.join(
            pandasgui.__path__[0], "images/plotly/trace-type-box.svg"
        ),
    ),
    Schema(
        name="violin",
        ...
        function=px.violin,
        icon_path=os.path.join(
            pandasgui.__path__[0], "images/plotly/trace-type-violin.svg"
        ),
    ),
    Schema(
        name="scatter_3d",
        ...
        icon_path=os.path.join(
            pandasgui.__path__[0], "images/plotly/trace-type-scatter3d.svg"
        ),
    ),
    Schema(
        ...
        icon_path=os.path.join(
            pandasgui.__path__[0], "images/plotly/trace-type-heatmap.svg"
        ),
    ),
    Schema(
        ...
        function=contour,
        icon_path=os.path.join(
            pandasgui.__path__[0], "images/plotly/trace-type-contour.svg"
        ),
    ),
    Schema(
        name="pie",
        args=[ColumnArg(arg_name="names"), ColumnArg(arg_name="values")],
        label="Pie",
        function=px.pie,
        icon_path=os.path.join(
            pandasgui.__path__[0], "images/plotly/trace-type-pie.svg"
        ),
    ),
    Schema(
        name="scatter_matrix",
        args=[ColumnArg(arg_name="dimensions"), ColumnArg(arg_name="color")],
        label="Splom",
        function=scatter_matrix,
        icon_path=os.path.join(
            pandasgui.__path__[0], "images/plotly/trace-type-splom.svg"
        ),
    ),
    Schema(
        name="word_cloud",
